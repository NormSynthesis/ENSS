 ...
 *
 */
public class NSFrequenciesChartThread 
extends Thread implements WindowListener {
	...
	private NSFrequenciesChartFrame chart;	
	 ...
	 */
	public NSFrequenciesChartThread(EvolutionaryNSM ensm) {
		this.refresh = false;
		
		chart = new NSFrequenciesChartFrame(ensm.getNormativeGamesNetwork());
